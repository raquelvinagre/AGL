...
public class Compilador extends aglBaseVisitor<String> {
    ...
    public String visitViewDeclaration(aglParser.ViewDeclarationContext ctx) {
        ...
        semanticAnaliser.addVariable("view", viewName);
    ...
    public String visitModelDeclaration(aglParser.ModelDeclarationContext ctx) {
        ...
        semanticAnaliser.addVariable(modelName, modelDefinition.toString());
    ...
    public String visitModelInstantiation(aglParser.ModelInstantiationContext ctx) {
        String modelName = ctx.ModelID().getText();
        String modelDefinition = semanticAnaliser.getVariable(modelName);
        ...
        for (String line : modelLines) {
            ...
            if (inComponentSection) {
                // Check for references in the components
                if (line.contains(":")) {
                    String[] parts = line.split(":");
                    String referenceName = parts[0].trim();
                    String component = parts[1].trim();
                    components.append(referenceName).append(" : ").append(component).append("=")
                            .append(semanticAnaliser.getVariable("view")).append("\n");
                } else {
        ...
        System.out.println("components: " + components.toString().trim());
    ...
    public String visitPropertyAssignment(aglParser.PropertyAssignmentContext ctx) {
        ...
        if (ctx.ID() != null) {
            ...
            propTemplate.add("viewName", semanticAnaliser.getVariable("view"));
    ...
    public String visitWaitCommand(aglParser.WaitCommandContext ctx) {
        ...
        waitTemplate.add("viewName", semanticAnaliser.getVariable(("view")));
    ...
    public String visitMoveCommand(aglParser.MoveCommandContext ctx) {
        ...
        moveTemplate.add("viewName", semanticAnaliser.getVariable("view"));
    ...
    public String visitObjectInstantiation(aglParser.ObjectInstantiationContext ctx) {
        ...
        if (coords.length() < 2) {
            ...
            if (semanticAnaliser.getVariables().containsKey(coords)) {
                coords = semanticAnaliser.getVariables().get(coords);
        ...
        objectTemplate.add("viewName", semanticAnaliser.getVariable("view"));
    ...
    public String visitVariableDeclaration(aglParser.VariableDeclarationContext ctx) {
        ...
        semanticAnaliser.addVariable(varName, value);
    ...
    public String visitListDeclaration(aglParser.ListDeclarationContext ctx) {
        ...
        semanticAnaliser.addVariable(listName, elements.toString());
    ...
    public String visitVariableUpdate(aglParser.VariableUpdateContext ctx) {
        ...
        if (ctx.expression() != null) {
            ...
            varTemplate.add("value", value);
            varTemplate.add("varName", varName);
            varTemplate.add("viewName", semanticAnaliser.getVariable("view"));

            semanticAnaliser.updateVariable(varName, value);
    ...
    public String visitObjectUpdate(aglParser.ObjectUpdateContext ctx) {
        ...
        for (String key : semanticAnaliser.getVariables().keySet()) {
            if (key.equals(objectType)) {
                objectType = key;
                // System.out.println("Object type: " + objectType);
                // System.out.println("Object properties: " + getVariables().get(key));
                break;
            }
        }
        ...
        semanticAnaliser.updateVariable(objectType, properties.toString());
